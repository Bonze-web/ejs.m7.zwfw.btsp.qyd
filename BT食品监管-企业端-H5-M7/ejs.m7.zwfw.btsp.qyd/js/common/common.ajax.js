...
(function (exports) {
    ...
    var ajax = function (options) {
        ...
        var func = function (resolve, reject) {
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4) {
                    ...
                    if ((xhr.status >= 200 && xhr.status < 300) || xhr.status === 304 || (xhr.status === 0 && xhr.responseText)) {
                        ...
                        if (!(status === 'abort' && settings.isMinirefreshRefresh)) {
                            // 下拉刷新的手动中断不用报错
            ...
            // 用于下拉刷新中断历史请求
            if (settings.isMinirefreshRefresh) {
                if (exports.xhrs.length > 0) {
                    exports.xhrs.forEach(function(element) {
                        element.abort();
                    });
                    exports.xhrs = [];
                }
                exports.xhrs.push(xhr);
            }
