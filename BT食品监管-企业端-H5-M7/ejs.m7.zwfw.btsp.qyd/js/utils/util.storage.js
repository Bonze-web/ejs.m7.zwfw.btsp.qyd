...
(function() {
    ...
    var innerUtil = {
         ...
         * @return {Object} 得到的是缓存的字符串数据或JSON数据
         */
        ...
        removeItem: function(id) {
            if (id !== undefined && id !== '') {
                try {
                    ...
                    console.error('localStorage删除值出错:' + id + ',' + JSON.stringify(e.getMessage()));
                }
            }
        },
        ...
        clear: function() {
            try {
                ...
                console.error('localStorage清空时出错:' + ',' + JSON.stringify(e.getMessage()));
            }
        },
        ...
        each: function(callback, options) {
            ...
            for (var i = localStorage.length - 1; i >= 0; i--) {
                ...
                if ((options.include
                    && !innerUtil._isMatch(options.include, key))
