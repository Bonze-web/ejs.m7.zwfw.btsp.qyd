...
(function (exports) {
    ...
    // exports.pripid = "123456789987654321";
    exports.pripid = "987654321123456789";
    Config.flag = 1;
    // 是否打开配置固定的pripid进行调试，为0的时候从接口获取真实参数，为1的时候从上面的pripid获取
    exports.localDebug = 0;
    /**
     * 业务接口相关的配置
     */
    var bizlogic = {
        ...
        // 测试的接口地址
        // serverUrlTest: 'http://139.224.18.191:3000/mock/7/'
        // serverUrlTest: '//172.20.241.134:8090/audit-jgtyzf-business-web/rest/'
        serverUrlTest: 'http://117.191.67.11:8081/qyd_cs/rest/'
    };
