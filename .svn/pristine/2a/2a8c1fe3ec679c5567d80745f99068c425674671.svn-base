...
(function(exports) {
     ...
     */
    MyDate.parseDate = function(dateString, pattern) {
        if (!dateString || typeof dateString === 'number') {
            // 普通的构造，时间戳、纯数字以及其它多参数构造情况（多参数情况，第一个参数也是数字）
            return new(Function.prototype.bind.apply(
                MyDate, [MyDate].concat(Array.prototype.slice.call(arguments))
            ))();
        }
        try {
            ...
            var matchs1 = pattern.match(SIGN_DATE_REG);
            ...
            if (matchs1.length > 0) {
                ...
                var myDate = new MyDate(1970, 0, 1);
     ...
     */
    MyDate.prototype.getAbsoluteMillonsTime = function(isTimezoneOffsetFixed) {
     ...
     */
    MyDate.prototype.toTimeStap = function(isTimezoneOffsetFixed) {
     ...
     */
    MyDate.prototype.nextSeconds = function(num) {
        num = num || 1;
    ...
    MyDate.prototype.nextMinutes = function(num) {
        num = num || 1;

        return this.nextSeconds(60 * num);
    };

    MyDate.prototype.nextHours = function(num) {
        num = num || 1;

        return this.nextMinutes(60 * num);
    };

    MyDate.prototype.nextDays = function(num) {
        num = num || 1;
     ...
     * @return {MyDate} 返回一个计算后的MyDate对象
     */
    MyDate.prototype.nextMonths = function(num) {
        num = num || 0;
    ...
    MyDate.prototype.nextYears = function(num) {
        num = num || 0;
     ...
     */
    MyDate.prototype.compare = function(another, pattern) {
