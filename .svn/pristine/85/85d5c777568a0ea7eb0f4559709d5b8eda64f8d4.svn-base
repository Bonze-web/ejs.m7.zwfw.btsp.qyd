    ...
    function loadDataFromFile(oFReader, file, success, error, type) {
        if (type === 'DataUrl') {
            ...
            image.onload = function() {
                success && success(getBase64Img(image));
            };
            ...
            return null;
        } else if (window.FileReader || !oFReader || !(oFReader instanceof FileReader)) {
