...
(function (d, $) {
    ...
    function initListeners() {
        ...
        $('#listdata').on('tap', '.btn-feedback', function (e) {
            ...
            ejs.page.open({
                pageUrl: './inspection_detail.html',
                pageStyle: 1,
                orientation: 1,
                data: {
        ...
        Zepto("body").on('tap', '.mui-table-view-cell', function (e) {
            ...
            if (this.dataset.status == '40') { // 待反馈
                linkurl = "./inspection_detail_waitfeed.html"
                ejs.page.open({
                    pageUrl: linkurl,
                    pageStyle: 1,
                    orientation: 1,
                ...
                linkurl = "./inspection_detail_done.html";
                ejs.page.open({
                    pageUrl: linkurl,
                    pageStyle: 1,
                    orientation: 1,
    ...
    function pullToRefresh() {
        ...
        minirefreshObj = new MiniRefreshBiz({
            url: Config.serverUrl + 'checkInfo/getCheckTaskList',
            initPageIndex: 1,
            contentType: 'application/json',
